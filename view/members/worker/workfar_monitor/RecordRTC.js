...
function MediaStreamRecorder(mediaStream) {
    ...
    this.record = function() {
        // http://dxr.mozilla.org/mozilla-central/source/view/media/MediaRecorder.cpp
...
// source code from: http://typedarray.org/wp-view/projects/WebAudioRecorder/script.js
...
function CanvasRecorder(htmlElement) {
    ...
    function drawCanvasFrame() {
        if (isPausedRecording) {
            ...
            return setTimeout(drawCanvasFrame, 1000);
        }
