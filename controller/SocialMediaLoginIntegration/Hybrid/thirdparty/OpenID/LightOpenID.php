...
class LightOpenID
{
    ...
    protected function request_curl($url, $method='GET', $params=array(), $update_claimed_id)
    {
        ...
        if ($method == 'POST') {
            ...
            curl_setopt($curl, CURLOPT_HTTPHEADER, array('Accept: controller/xrds+xml, */*'));
        }
    ...
    protected function request_streams($url, $method='GET', $params=array(), $update_claimed_id)
    {
        ...
        case 'GET':
            $opts = array(
                'http' => array(
                    'method' => 'GET',
                    'header' => 'Accept: controller/xrds+xml, */*',
    ...
    protected function is_allowed_type($content_type) {
        ...
        $allowed_types = array('controller/xrds+xml', 'text/html', 'text/xml');
